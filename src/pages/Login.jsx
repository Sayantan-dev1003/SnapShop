...
const Login = () => {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center w-full bg-slate-50 dark:bg-slate-950 transition-colors p-4 relative overflow-hidden">
            ...
            <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-brand-300 dark:bg-brand-900/30 rounded-full mix-blend-multiply dark:mix-blend-overlay filter blur-3xl opacity-30 animate-pulse-slow pointer-events-none"></div>
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-indigo-300 dark:bg-indigo-900/30 rounded-full mix-blend-multiply dark:mix-blend-overlay filter blur-3xl opacity-30 animate-[pulse_5s_cubic-bezier(0.4,0,0.6,1)_infinite] pointer-events-none"></div>
